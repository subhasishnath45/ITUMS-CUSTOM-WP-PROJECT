                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Company Name*" minlength="3" value="" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Mobile No*" minlength="10" maxlength="10" value="" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Contact Person*" minlength="3" value="" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="landline" class="form-control" placeholder="Landline No" value=""/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="branch" class="form-control" placeholder="Branches if any" value=""/>
                                        </div>
                                    </div>
